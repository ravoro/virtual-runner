...
class TestJourneysAddStageSubmit(BaseCase):
    def setUp(self):
        super().setUp()
    ...
    @patch.object(JourneyRepo, 'get')
    def test_non_final_stage(self, mock_get: Mock, mock_create: Mock):
    ...
    @patch.object(StageRepo, 'create')
    @patch.object(JourneyRepo, 'get')
    def test_final_stage_message(self, mock_get: Mock, mock_create: Mock):
